...
func (c Config) MarshalJSON() ([]byte, error) {
	...
	js, err := json.MarshalIndent(c.Services, "  ", "  ")
	if err != nil {
		return nil, err
	}
	buf.Write(js)
	if len(c.Networks) > 0 {
		buf.WriteString(",\n  \"networks\": ")
		js, err := json.MarshalIndent(c.Networks, "  ", "  ")
		if err != nil {
			return nil, err
		}
		buf.Write(js)
	...
	if len(c.Volumes) > 0 {
		buf.WriteString(",\n  \"volumes\": ")
		js, err := json.MarshalIndent(c.Volumes, "  ", "  ")
		if err != nil {
			return nil, err
		}
		buf.Write(js)
	...
	if len(c.Secrets) > 0 {
		buf.WriteString(",\n  \"secrets\": ")
		js, err := json.MarshalIndent(c.Secrets, "  ", "  ")
		if err != nil {
			return nil, err
		}
		buf.Write(js)
	...
	if len(c.Configs) > 0 {
		buf.WriteString(",\n  \"configs\": ")
		js, err := json.MarshalIndent(c.Configs, "  ", "  ")
		if err != nil {
			return nil, err
		}
		buf.Write(js)
	...
	if len(c.Extras) > 0 {
		buf.WriteString(",\n")
		js, err := json.MarshalIndent(c.Extras, "", "  ")
		if err != nil {
			return nil, err
		}
...
type ServiceConfig struct {
	...
	StopGracePeriod *time.Duration                   `mapstructure:"stop_grace_period"  yaml:"stop_grace_period,omitempty" json:"stop_grace_period,omitempty"`
...
type HealthCheckConfig struct {
	...
	Interval    *time.Duration  ` yaml:",omitempty" json:"interval,omitempty"`
	Retries     *uint64         ` yaml:",omitempty" json:"retries,omitempty"`
	StartPeriod *time.Duration  `mapstructure:"start_period"  yaml:"start_period,omitempty" json:"start_period,omitempty"`
...
type UpdateConfig struct {
	...
	Delay           time.Duration ` yaml:",omitempty" json:"delay,omitempty"`
	FailureAction   string        `mapstructure:"failure_action"  yaml:"failure_action,omitempty" json:"failure_action,omitempty"`
	Monitor         time.Duration ` yaml:",omitempty" json:"monitor,omitempty"`
...
type RestartPolicy struct {
	...
	Window      *time.Duration ` yaml:",omitempty" json:"window,omitempty"`
}
...
func (u *UlimitsConfig) MarshalJSON() ([]byte, error) {
	if u.Single != 0 {
		return []byte(fmt.Sprintf("%d", u.Single)), nil
	}
	ulimits := make(map[string]int)
	if u.Soft != 0 {
		ulimits["soft"] = u.Soft
	}
	if u.Hard != 0 {
...
func (e External) MarshalJSON() ([]byte, error) {
	...
	return []byte(fmt.Sprintf("{%q: %q}", "name", e.Name)), nil
}
